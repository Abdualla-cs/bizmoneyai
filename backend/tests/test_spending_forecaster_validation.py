...
def _row(month_start: str, *, clean: float, previous: float, two_months_ago: float, target: float) -> dict[str, object]:
    ...
    return {
        ...
        "expense_delta_1m": clean - previous,
        "expense_delta_2m": previous - two_months_ago,
        "monthly_expense_slope": (clean - two_months_ago) / 2.0,
        "last_3_month_growth_rate": (clean - two_months_ago) / two_months_ago,
